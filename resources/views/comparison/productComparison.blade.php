            ...
            <section class="h-full">
                <div class="p-8">
                    ...
                    <h1 class="text-xl mt-4">
                        <a href="{{route('product.show', ['category_id' => $comparedProducts['productOne']['product']->getCategory->category_name, 'slug' => $comparedProducts['productOne']['product']->slug])}}">{{$comparedProducts['productOne']['product']->name}}</a>
                    </h1>
                </div>
        ...
        @if(session('comparison.products.product_2'))
            <section class="h-full">
                <div class="p-8">
                    ...
                    <h1 class="text-xl mt-4">
                        <a href="{{route('product.show', ['category_id' => $comparedProducts['productTwo']['product']->getCategory->category_name, 'slug' => $comparedProducts['productTwo']['product']->slug])}}">{{$comparedProducts['productTwo']['product']->name}}</a>
                    </h1>
                </div>
