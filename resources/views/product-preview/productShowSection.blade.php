<li class="product-container bg-white shadow-xl h-96 border w-90 p-2">
    <a href="{{route('product.show', ['category_id' => $product->getCategory->category_name, 'slug' => $product->slug])}}">
        ...
        <div class="product-information">
            <h2 class="h-10 text-lg font-semibold">
                <a href="{{route('product.show', ['category_id' => $product->getCategory->category_name, 'slug' => $product->slug])}}">{{$product->name}}</a>
            </h2>
