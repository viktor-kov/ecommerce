    ...
    <section class="grid grid-cols-1 lg:grid-cols-4 p-1">
        <nav class="w-full">
            <ul class="text-lg font-semibold">
                ...
                <li class="mb-1"><a href="{{route('products.storage')}}" class="block p-4 border border-black hover:bg-gray-100">{{__('admin.warehouse')}}</a></li>
                <li class="mb-1"><a href="{{route('tickets.all')}}" class="block p-4 border border-black hover:bg-gray-100">{{__('ticket.support')}}</a></li>
            </ul>
        </nav>
